<template>
  <div class="rotate">
    ...
    <div class="rotate-button">
      <div class="button" @click="onRotateLeftClick">向左旋转</div>
      <div class="button" @click="onRotateRightClick">向右旋转</div>
    </div>
  </div>
</template>
...
const { useRotate } = pkg.hooks

const rotateDeg = ref(0)
const onRotateLeftClick = () => {
  rotateDeg.value -= 45
  useRotate(".btn", rotateDeg.value)
  console.log("left")
}
const onRotateRightClick = () => {
  rotateDeg.value += 45
  useRotate(".btn", rotateDeg.value)
  console.log("right")
}
